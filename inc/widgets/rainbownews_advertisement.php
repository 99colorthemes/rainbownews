...
class rainbownews_advertisement extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array( 'classname' => 'widget_advertisement', 'description' => __( 'Add your 728x90 Advertisement', 'rainbownews') );
        $control_ops = array( 'width' => 200, 'height' =>250 );
        parent::__construct( false,$name= __( 'NNC: Advertisement', 'rainbownews' ),$widget_ops);
    }
